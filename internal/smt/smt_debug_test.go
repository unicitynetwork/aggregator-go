...
func TestAddLeaves_DebugInvalidPath(t *testing.T) {
	...
	addCommitment := func(tree *SparseMerkleTree, commJson map[string]interface{}) string {
		...
		require.NoError(t, err, "Failed to marshal certification request JSON")
		...
		require.NoError(t, err)
		require.NotNil(t, merkleTreePath, "Expected non-nil Merkle tree path for valid state ID")
	...
	{ // mint commitment
		commJson := map[string]interface{}{
			"stateId": "7d535ade796772c5088b095e79a18e282437ee8d8238f5aa9d9c61694948ba9e",
			"certificationData": map[string]interface{}{
				...
				"sourceStateHash": "e5a2521a3b309282d71359a02ee75c4ac378f12fffda070fa83cc6e1588c522d",
				"transactionHash": "784d629eb9530b02c35d66eea760354bfdf55eddffc14823774137add2858ccd",
			},
		}
	...
	{ // transfer commitment
		commJson := map[string]interface{}{
			"stateId": "6478ca42f6949cfbd4b9e4a41b9a384ea78261c1776808da70cf21e98c345700",
			"certificationData": map[string]interface{}{
				...
				"sourceStateHash": "ec68788d7b58afba297ecaf1859a3204a98dc109a222814569ca84d50c63c9f5",
				"transactionHash": "cbbea2c8ce3ca54649210fa5f4febd4f2418d011a89800081f28f6c419f45ee9",
			},
		}
	...
	{
		req, err := api.NewImprintV2("6df936060e07cad29086335623b2a05afef0b05f77dcc27f6e5065abce6f061d")
