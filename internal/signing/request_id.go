...
func (g *RequestIDGenerator) CreateRequestID(publicKey []byte, stateHashBytes []byte) (models.RequestID, error) {
	...
	requestID := models.RequestID(requestIDStr)
	
	return requestID, nil
}

// ValidateRequestID validates that a request ID matches the expected value for the given public key and state hash
func (g *RequestIDGenerator) ValidateRequestID(requestID models.RequestID, publicKey []byte, stateHashBytes []byte) (bool, error) {
